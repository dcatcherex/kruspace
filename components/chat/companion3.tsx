...
const Companion3 = () => {
    ...
    const companion3 = useChatStore((state) => state.companion3);
    const updateCompanion3 = useChatStore((state) => state.updateCompanion3);
            ...
            <DropdownMenuContent align="center">
              ...
              {miniCompanion.map((item) => (
                <DropdownMenuItem
                  ...
                  onClick={() => updateCompanion3(item.titleTH)}
                >
                  {item.titleTH}{" "}
                </DropdownMenuItem>
              ))}
