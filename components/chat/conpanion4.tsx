...
const Companion4 = () => {
    ...
    const companion4 = useChatStore((state) => state.companion4);
    const updateCompanion4 = useChatStore((state) => state.updateCompanion4);
            ...
            <DropdownMenuContent align="center">
              ...
              {miniCompanion.map((item) => (
                <DropdownMenuItem
                  ...
                  onClick={() => updateCompanion4(item.titleTH)}
                >
                  {item.titleTH}{" "}
                </DropdownMenuItem>
              ))}
