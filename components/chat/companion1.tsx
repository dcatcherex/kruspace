...
const Companion1 = () => {
    ...
    const companion1 = useChatStore((state) => state.companion1);
    const updateCompanion1 = useChatStore((state) => state.updateCompanion1);
            ...
            <DropdownMenuContent align="center">
              ...
              {miniCompanion.map((item) => (
                <DropdownMenuItem
                  ...
                  onClick={() => updateCompanion1(item.titleTH)}
                >
                  {item.titleTH}{" "}
                </DropdownMenuItem>
              ))}
