...
const TeachingCard = ({ card }: TeachingCardProps) => {
  ...
  return (
    ...
    >
      ...
      {card.map((item) => (
            ...
            <li key={item.id} className="relative col-span-1 flex flex-col justify-between rounded-md border-[1px] border-l-8 border-l-sky-500 bg-white text-left shadow-sm  transition duration-150 ease-in-out  hover:ring-4 dark:bg-black  md:border-l-[1px] md:border-l-gray-200">
              <div className="">
                <div
