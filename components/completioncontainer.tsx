    ...
    <section className="space-y-6 pb-8  md:pb-12 md: lg:">
      <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
        <Tabs defaultValue="lessonplan" className="max-w-[800px]">
          <TabsList>
            <TabsTrigger value="lessonplan"><NewspaperIcon className="w-5 h-5 mr-1 stroke-muted-foreground stroke-2"/>แผนการสอน</TabsTrigger>
          ...
          <TabsContent value="lessonplan">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Base on &quot;Teaching with AI&quot; by OpenAI in collaboration with Ethan Mollick and Lilach Mollick
